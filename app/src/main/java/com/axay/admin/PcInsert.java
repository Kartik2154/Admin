...
public class PcInsert extends AppCompatActivity {
    Button insert,ViewAll;
    EditText product_name,ram,SSD,color,price,image,shop_name;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_pc_insert);
        ...
        ViewAll.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(PcInsert.this, PcView.class);
